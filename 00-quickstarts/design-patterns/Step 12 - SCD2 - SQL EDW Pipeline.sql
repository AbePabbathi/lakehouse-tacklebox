...
USING iot_dashboard.temp_batch_to_insert AS source
...
INSERT INTO iot_dashboard.silver_sensors_scd_2
...
FROM iot_dashboard.temp_batch_to_insert AS source;
...
--TRUNCATE TABLE iot_dashboard.bronze_sensors_scd_2;
