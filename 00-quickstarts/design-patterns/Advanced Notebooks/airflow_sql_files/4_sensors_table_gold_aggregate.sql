CREATE OR REPLACE TABLE main.iot_dashboard_airflow.hourly_summary_statistics
AS
SELECT user_id,
...
CREATE OR REPLACE TABLE main.iot_dashboard_airflow.smoothed_hourly_statistics
AS 
SELECT *,
-- Number of Steps
...
FROM main.iot_dashboard_airflow.hourly_summary_statistics;